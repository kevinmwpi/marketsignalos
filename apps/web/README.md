...
- `${NEXT_PUBLIC_API_BASE_URL}/signals/suspicious-accounts?fresh_days=30&min_resolved=20&baseline_win_rate=0.5&sigma_threshold=3&only_significant=true&limit=20`
