...
def main() -> int:
    ...
    e_first = PolymarketWalletEnrichment(
        ...
        edge_mean=0.42, edge_lower_bound=0.18, effective_sample_size=42.0,
        resolved_volume_usdc=400000.0, rank_score=2.4,
    ...
    e_second = PolymarketWalletEnrichment(
        ...
        edge_mean=0.48, edge_lower_bound=0.22, effective_sample_size=50.0,
        resolved_volume_usdc=480000.0, rank_score=2.9,
